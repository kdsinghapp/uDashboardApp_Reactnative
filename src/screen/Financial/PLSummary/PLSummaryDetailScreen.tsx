  ...
  return (
    <SafeAreaView edges={['top']} style={{
      ...
      <ScrollView style={styles.container}>
        ...
        {/* Due Date */}
        {item?.profit_and_loss_date &&
          <View style={styles.row}>
            <Text style={styles.label}>Profit & Loss Date</Text>
            <Text style={styles.value}>{moment(item?.profit_and_loss_date).format('MMM, DD YYYY')}</Text>
          </View>
        }
        <View style={styles.row}>
...
export default PLSummaryDetailScreen;
